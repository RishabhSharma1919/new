        ...
        >
          <div className="list-column__header" {...provided.dragHandleProps}>
            ...
            <div className="list-column__actions">
              <button className="list-column__menu" onClick={() => void onDeleteList(list.id)} type="button" aria-label="Delete list">
          ...
          <Droppable droppableId={list.id.toString()} type="CARD" isDropDisabled={dragDisabled}>
